...
class XmlDiff
{
    ...
    public $dtdGroup = [  // stems and leaves (at each XML tree type) for layout and navigation
        '' => ['isHTML' => false, 'stems' => '', 'leaves' => ''] // default = no type
        , 'html' => [
    ...
    {
        if (is_array($dtd)) {
            [$dtd, $this->opt_doTree, $this->opt_popLink, $this->opt_rmIdx] = $dtd;
        }
